...
- **Project-specific**: `.Codex/skills/[skill-name]/SKILL.md`
- **User-wide**: `~/.Codex/skills/[skill-name]/SKILL.md`
...
capture_thought({
  "content": "New skill created: [skill-name]. [1-2 sentence summary of what it solves].
              Trigger: [exact trigger condition]. Location: ~/.Codex/skills/[name]/SKILL.md"
})
```
...
**Step 2 - Check existing skills**: Search `~/.Codex/skills/` for n8n-related skills.
...
**Step 4 - Save**: `~/.Codex/skills/n8n-workflow-api-quirks/SKILL.md`
