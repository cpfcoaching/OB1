...
import { n as require_index_node_cjs, t as require_index_cjs$1 } from "./component+[...].mjs";
//#region node_modules/@firebase/logger/dist/index.cjs.js
...
//#endregion
//#region node_modules/@firebase/database-compat/dist/index.standalone.js
var require_index_standalone = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	var require$$2 = __require("util");
	var require$$0 = __require("buffer");
	var require$$1 = __require("events");
	var require$$0$1 = __require("stream");
	var require$$1$1 = __require("crypto");
	var require$$2$1 = __require("url");
	var require$$1$2 = __require("net");
	var require$$2$2 = __require("tls");
	var require$$2$3 = require_index_node_cjs();
	var require$$1$3 = require_index_cjs();
	var require$$0$2 = require_index_cjs$1();
	...
	(function(module$1, exports$1) {
		...
		if (Buffer.from && Buffer.alloc && Buffer.allocUnsafe && Buffer.allocUnsafeSlow) module$1.exports = buffer;
		else {
	...
	**/
	...
	var instance$b = {
		...
		start: function() {
			if (this.readyState !== 0) return false;
			if (!Base$7.isWebSocket(this._request)) return this._failHandshake(/* @__PURE__ */ new Error("Not a WebSocket request"));
			var response;
			try {
	...
	var TOKEN = /([!#\$%&'\*\+\-\.\^_`\|~0-9A-Za-z]+)/, NOTOKEN = /([^!#\$%&'\*\+\-\.\^_`\|~0-9A-Za-z])/g, PARAM = new RegExp(TOKEN.source + "(?:=(?:" + TOKEN.source + "|" + /"((?:\\[\x00-\x7f]|[^\x00-\x08\x0a-\x1f\x7f"\\])*)"/.source + "))?"), EXT = new RegExp(TOKEN.source + "(?: *; *" + PARAM.source + ")*", "g"), EXT_LIST = new RegExp("^" + EXT.source + "(?: *, *" + EXT.source + ")*$"), NUMBER = /^-?(0|[1-9][0-9]*)(\.[0-9]+)?$/;
	...
	var instance$a = {
		...
		validFrameRsv: function(frame) {
			...
			if (Extensions$1.MESSAGE_OPCODES.indexOf(frame.opcode) >= 0) for (var i = 0, n = this._sessions.length; i < n; i++) {
	...
	var instance$6 = {
		...
		write: function(chunk) {
			...
			if (this.statusCode === 200) this.emit("connect", new Base$5.ConnectEvent());
			else {
	...
	var instance$3 = {
		...
		_parseLeadingByte: function(octet) {
			if (octet !== 255) return Draft75$1.prototype._parseLeadingByte.call(this, octet);
			this._closing = true;
			this._length = 0;
			this._stage = 1;
		}
	...
	var instance$1 = {
		...
		_receiveMessage: function(data) {
			...
			var event = new Event$1("message", { data });
			event.initEvent("message", false, false);
			this.dispatchEvent(event);
		},
		_emitError: function(message) {
			if (this.readyState >= API$3.CLOSING) return;
			var event = new Event$1("error", { message });
	...
	*/
	...
	var require$$3 = /* @__PURE__ */ getAugmentedNamespace(/* @__PURE__ */ Object.freeze({
		__proto__: null,
		deleteDB,
		openDB,
		unwrap,
	...
	(function(exports$2) {
		...
		*/
		...
		const ERROR_FACTORY = new util.ErrorFactory("app", "Firebase", {
		...
		*/
		class FirebaseAppImpl {
			constructor(options, config, container) {
				...
				this.container.addComponent(new component.Component("app", () => this, "PUBLIC"));
			}
		...
		*/
		...
		function initializeApp(_options, rawConfig = {}) {
			...
			if (existingApp) if (util.deepEqual(options, existingApp.options) && util.deepEqual(config, existingApp.config)) return existingApp;
		...
		function initializeServerApp(_options, _serverAppConfig = {}) {
			if (util.isBrowser() && !util.isWebWorker()) throw ERROR_FACTORY.create("invalid-server-app-environment");
			let firebaseOptions;
		...
		*/
		function getApp(name = DEFAULT_ENTRY_NAME) {
			...
			if (!app && name === DEFAULT_ENTRY_NAME && util.getDefaultAppConfig()) return initializeApp();
		...
		*/
		...
		function getDbPromise() {
			if (!dbPromise) dbPromise = idb.openDB(DB_NAME, DB_VERSION, { upgrade: (db, oldVersion) => {
				switch (oldVersion) {
					case 0: try {
		...
		async function readHeartbeatsFromIndexedDB(app) {
			try {
				...
				if (e instanceof util.FirebaseError) logger.warn(e.message);
				else {
		...
		*/
		...
		class HeartbeatStorageImpl {
			...
			async runIndexedDBEnvironmentCheck() {
				...
				else return util.validateIndexedDBOpenable().then(() => true).catch(() => false);
			}
			/**
			* Read all heartbeats.
			*/
		...
		*/
		function registerCoreComponents(variant) {
			_registerComponent(new component.Component("platform-logger", (container) => new PlatformLoggerServiceImpl(container), "PRIVATE"));
			_registerComponent(new component.Component("heartbeat", (container) => new HeartbeatServiceImpl(container), "PRIVATE"));
		...
		*/
		...
		Object.defineProperty(exports$2, "FirebaseError", {
			enumerable: true,
			get: function() {
				return util.FirebaseError;
			}
		});
		exports$2.SDK_VERSION = SDK_VERSION;
		exports$2._DEFAULT_ENTRY_NAME = DEFAULT_ENTRY_NAME;
		exports$2._addComponent = _addComponent;
		exports$2._addOrOverwriteComponent = _addOrOverwriteComponent;
		exports$2._apps = _apps;
		exports$2._clearComponents = _clearComponents;
		exports$2._components = _components;
		exports$2._getProvider = _getProvider;
		exports$2._isFirebaseApp = _isFirebaseApp;
		exports$2._isFirebaseServerApp = _isFirebaseServerApp;
		exports$2._isFirebaseServerAppSettings = _isFirebaseServerAppSettings;
		exports$2._registerComponent = _registerComponent;
		exports$2._removeServiceInstance = _removeServiceInstance;
		exports$2._serverApps = _serverApps;
		exports$2.deleteApp = deleteApp;
		exports$2.getApp = getApp;
		exports$2.getApps = getApps;
		exports$2.initializeApp = initializeApp;
		exports$2.initializeServerApp = initializeServerApp;
		exports$2.onLog = onLog;
		exports$2.registerVersion = registerVersion;
		exports$2.setLogLevel = setLogLevel;
	})(index_cjs);
	...
	var DOMStorageWrapper = class {
		...
		*/
		set(key, value) {
			...
			else this.domStorage_.setItem(this.prefixedName_(key), util.stringify(value));
		}
		/**
		...
		*/
		get(key) {
			...
			else return util.jsonEval(storedVal);
		}
		remove(key) {
	...
	*/
	...
	var buildLogMessage_ = function(...varArgs) {
		...
		for (let i = 0; i < varArgs.length; i++) {
			...
			else if (typeof arg === "object") message += util.stringify(arg);
			else message += arg;
			message += " ";
		}
		return message;
	...
	*/
	var warnIfPageIsSecure = function() {
		if (typeof window !== "undefined" && window.location && window.location.protocol && window.location.protocol.indexOf("https:") !== -1) warn$1("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().");
	};
	/**
	...
	*/
	...
	var executeWhenDOMReady = function(fn) {
		if (util.isNodeSdk() || document.readyState === "complete") fn();
		else {
			let called = false;
	...
	*/
	...
	var requireKey = function(key, obj) {
		...
		else throw new Error("Missing required key (" + key + ") in object: " + util.stringify(obj));
	};
	...
	*/
	var exceptionGuard = function(fn) {
		try {
			...
			setTimeout(() => {
				warn$1("Exception was thrown by user callback.", e.stack || "");
				throw e;
			}, Math.floor(0));
		}
	};
	...
	var WebSocketConnection = class WebSocketConnection {
		...
		*/
		static connectionURL_(repoInfo, transportSessionId, lastSessionId, appCheckToken, applicationId) {
			...
			if (!util.isNodeSdk() && typeof location !== "undefined" && location.hostname && FORGE_DOMAIN_RE.test(location.hostname)) urlParams[REFERER_PARAM] = FORGE_REF;
	...
	*/
	var AppCheckTokenProvider = class {
		constructor(app$1, appCheckProvider) {
			...
			if (app._isFirebaseServerApp(app$1) && app$1.settings.appCheckToken) this.serverAppAppCheckToken = app$1.settings.appCheckToken;
	...
	*/
	var BrowserPollConnection = class BrowserPollConnection {
		...
		*/
		...
		static isAvailable() {
			if (util.isNodeSdk()) return false;
		...
		*/
		send(data) {
			...
			this.bytesSent += dataStr.length;
			this.stats_.incrementCounter("bytes_sent", dataStr.length);
			const dataSegs = splitStringBySize(util.base64Encode(dataStr), MAX_PAYLOAD_SIZE);
	...
	*********************************************************************************************/
	var FirebaseIFrameScriptHolder = class FirebaseIFrameScriptHolder {
		...
		*/
		addTag(url, loadCB) {
			if (util.isNodeSdk()) this.doNodeLongPoll(url, loadCB);
			else setTimeout(() => {
				try {
		...
		*/
		...
		initTransports_(repoInfo) {
			...
			if (repoInfo.webSocketOnly) {
				if (!isWebSocketsAvailable) warn$1("wss:// URL used, but browser isn't known to support websockets.  Trying anyway.");
		...
		*/
		onHandshake_(handshake) {
			...
			if (this.state_ === 0) {
				...
				if (PROTOCOL_VERSION !== version) warn$1("Protocol version mismatch detected");
	...
	var ValidationPath = class {
		...
		*/
		constructor(path, errorPrefix_) {
			...
			for (let i = 0; i < this.parts_.length; i++) this.byteLength_ += util.stringLength(this.parts_[i]);
	...
	var PersistentConnection = class PersistentConnection extends ServerActions {
		...
		*/
		...
		static warnOnListenWarnings_(payload, query) {
			if (payload && typeof payload === "object" && util.contains(payload, "w")) {
				...
				if (Array.isArray(warnings) && ~warnings.indexOf("no_index")) warn$1(`Using an unspecified index. Your data will be downloaded and filtered on the client. Consider adding ${"\".indexOn\": \"" + query._queryParams.getIndex().toString() + "\""} at ${query._path.toString()} to your security rules for better performance.`);
			}
		}
		refreshAuthToken(token) {
		...
		reduceReconnectDelayIfAdminCredential_(credential) {
			if (credential && credential.length === 40 || util.isAdmin(credential)) {
		...
		*/
		...
		onDataPush_(action, body) {
			...
			else error("Unrecognized action received from server: " + util.stringify(action) + "\nAre you using the latest client?");
		}
		...
		async establishConnection_() {
			if (this.shouldReconnect_()) {
				...
				try {
					...
					if (!canceled) {
						if (this.repoInfo_.nodeAdmin) warn$1(error);
						closeFn();
					}
				}
			}
		...
		*/
		sendConnectStats_() {
			const stats = {};
			let clientName = "js";
			if (util.isNodeSdk()) if (this.repoInfo_.nodeAdmin) clientName = "admin_node";
			else clientName = "node";
			stats["sdk." + clientName + "." + SDK_VERSION.replace(/\./g, "-")] = 1;
			if (util.isMobileCordova()) stats["framework.cordova"] = 1;
			else if (util.isReactNative()) stats["framework.reactnative"] = 1;
	...
	*/
	var validatePriorityNode = function(priorityNode) {
		...
		} else util.assert(priorityNode === MAX_NODE$2 || priorityNode.isEmpty(), "priority of unexpected type.");
	...
	var IndexMap = class IndexMap {
		...
		*/
		addToIndexes(namedNode, existingChildren) {
			return new IndexMap(util.map(this.indexes_, (indexedChildren, indexName) => {
		...
		*/
		removeFromIndexes(namedNode, existingChildren) {
			return new IndexMap(util.map(this.indexes_, (indexedChildren) => {
		...
		*/
		constructor(children_, priorityNode_, indexMap_) {
			...
			*/
			...
			if (this.children_.isEmpty()) util.assert(!this.priorityNode_ || this.priorityNode_.isEmpty(), "An empty node cannot have a priority");
		}
		/** @inheritDoc */
		isLeafNode() {
			return false;
	...
	*/
	var IndexedFilter = class {
		...
		updateChild(snap, key, newChild, affectedPath, source, optChangeAccumulator) {
			...
			else util.assert(snap.isLeafNode(), "A child remove without an old child only makes sense on a leaf node");
	...
	*/
	function queryParamsToRestQueryStringParameters(queryParams) {
		...
		if (queryParams.startSet_) {
			...
			if (queryParams.startNameSet_) qs[startParam] += "," + util.stringify(queryParams.indexStartName_);
		}
		if (queryParams.endSet_) {
			const endParam = queryParams.endBeforeSet_ ? "endBefore" : "endAt";
			qs[endParam] = util.stringify(queryParams.indexEndValue_);
			if (queryParams.endNameSet_) qs[endParam] += "," + util.stringify(queryParams.indexEndName_);
		}
				...
				xhr.onreadystatechange = () => {
					if (callback && xhr.readyState === 4) {
						...
						if (xhr.status >= 200 && xhr.status < 300) {
							...
							if (xhr.status !== 401 && xhr.status !== 404) warn$1("Got unsuccessful REST response for " + url + " Status: " + xhr.status);
							callback(xhr.status);
						}
						callback = null;
					}
	...
	*/
	...
	function eventGeneratorCompareChanges(eventGenerator, a, b) {
		if (a.childName == null || b.childName == null) throw util.assertionError("Should only compare child_ events.");
	...
	function writeTreeLayerTree_(writes, filter, treeRoot) {
		...
		for (let i = 0; i < writes.length; ++i) {
			...
			if (filter(write)) {
				...
				} else throw util.assertionError("WriteRecord should have .snap or .children");
			}
		}
	...
	var ChildChangeAccumulator = class {
		...
		trackChildChange(change) {
			...
			if (oldChange) {
				...
				else throw util.assertionError("Illegal combination of changes: " + change + " occurred after " + oldChange);
	...
	*/
	...
	function viewProcessorApplyOperation(viewProcessor, oldViewCache, operation, writesCache, completeCache) {
		...
		else throw util.assertionError("Unknown operation type: " + operation.type);
	...
	*/
	function syncTreeSetupListener_(syncTree, query, view) {
		...
		const subtree = syncTree.syncPointTree_.subtree(path);
		if (tag) util.assert(!syncPointHasCompleteView(subtree.value), "If we're adding a query, it shouldn't be shadowed");
		else {
	...
	*/
	var resolveDeferredLeafValue = function(value, existingVal, serverValues) {
		...
		else util.assert(false, "Unexpected server value: " + JSON.stringify(value, null, 2));
	};
	var resolveScalarDeferredValue = function(op, existing, serverValues) {
		switch (op) {
			case "timestamp": return serverValues["timestamp"];
			default: util.assert(false, "Unexpected server value: " + op);
		}
	};
	var resolveComplexDeferredValue = function(op, existing, unused) {
		if (!op.hasOwnProperty("increment")) util.assert(false, "Unexpected server value: " + JSON.stringify(op, null, 2));
		const delta = op["increment"];
		if (typeof delta !== "number") util.assert(false, "Unexpected increment value: " + delta);
	...
	*/
	var validateFirebaseData = function(errorPrefix, data, path_) {
		...
		if (typeof data === "string" && data.length > MAX_LEAF_SIZE_ / 3 && util.stringLength(data) > MAX_LEAF_SIZE_) throw new Error(errorPrefix + "contains a string greater than 10485760 utf8 bytes " + validationPathToErrorString(path) + " ('" + data.substring(0, 50) + "...')");
	...
	*/
	var validateFirebaseMergeDataArg = function(fnName, data, path, optional) {
		...
		if (!(data && typeof data === "object") || Array.isArray(data)) throw new Error(errorPrefix + " must be an object containing the children to replace.");
		const mergePaths = [];
		each(data, (key, value) => {
			const curPath = new Path(key);
			validateFirebaseData(errorPrefix, value, pathChild(path, curPath));
			if (pathGetBack(curPath) === ".priority") {
				if (!isValidPriority(value)) throw new Error(errorPrefix + "contains an invalid value for '" + curPath.toString() + "', which must be a valid Firebase priority (a string, finite number, server value, or null).");
			}
	...
	var validatePriority = function(fnName, priority, optional) {
		...
		if (isInvalidJSONNumber(priority)) throw new Error(util.errorPrefix(fnName, "priority") + "is " + priority.toString() + ", but must be a valid Firebase priority (a string, finite number, server value, or null).");
		if (!isValidPriority(priority)) throw new Error(util.errorPrefix(fnName, "priority") + "must be a valid Firebase priority (a string, finite number, server value, or null).");
	};
	var validateKey = function(fnName, argumentName, key, optional) {
		if (optional && key === void 0) return;
		if (!isValidKey(key)) throw new Error(util.errorPrefix(fnName, argumentName) + "was an invalid key = \"" + key + "\".  Firebase keys must be non-empty strings and can't contain \".\", \"#\", \"$\", \"/\", \"[\", or \"]\").");
	};
	/**
	* @internal
	*/
	var validatePathString = function(fnName, argumentName, pathString, optional) {
		...
		if (!isValidPathString(pathString)) throw new Error(util.errorPrefix(fnName, argumentName) + "was an invalid path = \"" + pathString + "\". Paths must be non-empty strings and can't contain \".\", \"#\", \"$\", \"[\", or \"]\"");
	};
	...
	*/
	...
	var validateUrl = function(fnName, parsedUrl) {
		...
		if (!(typeof parsedUrl.repoInfo.host === "string") || parsedUrl.repoInfo.host.length === 0 || !isValidKey(parsedUrl.repoInfo.namespace) && parsedUrl.repoInfo.host.split(":")[0] !== "localhost" || pathString.length !== 0 && !isValidRootPathString(pathString)) throw new Error(util.errorPrefix(fnName, "url") + "must be a valid firebase URL and the path can't contain \".\", \"#\", \"$\", \"[\", or \"]\".");
	};
	/**
	* @license
	* Copyright 2017 Google LLC
	...
	*/
	...
	function repoSetWithPriority(repo, path, newVal, newPriority, onComplete) {
		...
		repo.server_.put(path.toString(), newNodeUnresolved.val(true), (status, errorReason) => {
			...
			if (!success) warn$1("set at " + path + " failed: " + status);
	...
	function repoUpdate(repo, path, childrenToMerge, onComplete) {
		...
		if (!empty) {
			...
			repo.server_.merge(path.toString(), childrenToMerge, (status, errorReason) => {
				const success = status === "ok";
				if (!success) warn$1("update at " + path + " failed: " + status);
				const clearEvents = syncTreeAckUserWrite(repo.serverSyncTree_, writeId, !success);
		...
		for (let i = 0; i < queue.length; i++) {
			...
			if (transaction.status === 4) {
				...
				if (newData !== void 0) {
					...
					if (!(typeof newData === "object" && newData != null && util.contains(newData, ".priority"))) newDataNode = newDataNode.updatePriority(currentNode.getPriority());
	...
	*/
	function decodeQuery(queryString) {
		...
		for (const segment of queryString.split("&")) {
			...
			else warn$1(`Invalid query segment '${segment}' in query '${queryString}'`);
		}
		return results;
	}
	...
	*/
	var DataSnapshot$1 = class DataSnapshot$1 {
		/**
	...
	*/
	function repoManagerApplyEmulatorSettings(repo, hostAndPort, emulatorOptions, tokenProvider) {
		...
		repo.repoInfo_ = new RepoInfo(hostAndPort, util.isCloudWorkstation(host), repo.repoInfo_.namespace, repo.repoInfo_.webSocketOnly, repo.repoInfo_.nodeAdmin, repo.repoInfo_.persistenceKey, repo.repoInfo_.includeNamespaceInQueryParams, true, emulatorOptions);
	...
	*/
	function repoManagerDatabaseFromApp(app, authProvider, appCheckProvider, url, nodeAdmin) {
		...
		return new Database$1(repoManagerCreateRepo(repoInfo, app, authTokenProvider, new AppCheckTokenProvider(app, appCheckProvider)), app);
	}
	/**
	...
	*/
	...
	function checkTransportInit() {
		if (TransportManager.IS_TRANSPORT_INITIALIZED) warn$1("Transport has already been initialized. Please call this function before calling ref or setting up a listener");
	}
	/**
	...
	*/
	function connectDatabaseEmulator(db, host, port, options = {}) {
		...
		if (db._instanceStarted) {
			if (hostAndPort === db._repoInternal.repoInfo_.host && util.deepEqual(options, repo.repoInfo_.emulatorOptions)) return;
		...
		} else if (options.mockUserToken) tokenProvider = new EmulatorTokenProvider(typeof options.mockUserToken === "string" ? options.mockUserToken : util.createMockUserToken(options.mockUserToken, db.app.options.projectId));
		if (util.isCloudWorkstation(host)) util.pingServer(host);
	...
	* limitations under the License.
	*/
	var logClient = new require$$1$3.Logger("@firebase/database-compat");
	...
	*/
	var validateBoolean = function(fnName, argumentName, bool, optional) {
		if (optional && bool === void 0) return;
		if (typeof bool !== "boolean") throw new Error(require$$2$3.errorPrefix(fnName, argumentName) + "must be a boolean.");
	};
	var validateEventType = function(fnName, eventType, optional) {
		if (optional && eventType === void 0) return;
		switch (eventType) {
			case "value":
			case "child_added":
			case "child_removed":
			...
			default: throw new Error(require$$2$3.errorPrefix(fnName, "eventType") + "must be a valid event type = \"value\", \"child_added\", \"child_removed\", \"child_changed\", or \"child_moved\".");
		}
	};
	/**
	* @license
	...
	*/
	var Query = class Query {
		...
		on(eventType, callback, cancelCallbackOrContext, context) {
			...
			switch (eventType) {
				...
				case "child_moved":
					...
					return callback;
				default: throw new Error(require$$2$3.errorPrefix("Query.on", "eventType") + "must be a valid event type = \"value\", \"child_added\", \"child_removed\", \"child_changed\", or \"child_moved\".");
			}
		}
		off(eventType, callback, context) {
			...
			} else off_1(this._delegate, eventType);
		}
		/**
		...
		*/
		once(eventType, callback, failureCallbackOrContext, context) {
			...
			switch (eventType) {
				case "value":
					onValue_1(this._delegate, valueCallback, cancelCallback, { onlyOnce: true });
					break;
				case "child_added":
					onChildAdded_1(this._delegate, valueCallback, cancelCallback, { onlyOnce: true });
					break;
				case "child_removed":
					onChildRemoved_1(this._delegate, valueCallback, cancelCallback, { onlyOnce: true });
					break;
				case "child_changed":
					onChildChanged_1(this._delegate, valueCallback, cancelCallback, { onlyOnce: true });
					break;
				case "child_moved":
					onChildMoved_1(this._delegate, valueCallback, cancelCallback, { onlyOnce: true });
					break;
				default: throw new Error(require$$2$3.errorPrefix("Query.once", "eventType") + "must be a valid event type = \"value\", \"child_added\", \"child_removed\", \"child_changed\", or \"child_moved\".");
			}
			return deferred.promise;
		}
		/**
		...
		*/
		isEqual(other) {
			...
			if (!(other instanceof Query)) throw new Error("Query.isEqual failed: First argument must be an instance of firebase.database.Query.");
		...
		*/
		static getCancelAndContextArgs_(fnName, cancelOrContext, context) {
			...
			} else if (cancelOrContext) if (typeof cancelOrContext === "object" && cancelOrContext !== null) ret.context = cancelOrContext;
			else if (typeof cancelOrContext === "function") ret.cancel = cancelOrContext;
			else throw new Error(require$$2$3.errorPrefix(fnName, "cancelOrContext") + " must either be a cancel callback or a context object.");
			return ret;
		}
		get ref() {
	...
	var Reference = class Reference extends Query {
		/**
		* Call options:
		...
		*/
		...
		transaction(transactionUpdate, onComplete, applyLocally) {
			...
			const result = runTransaction_1(this._delegate, transactionUpdate, { applyLocally }).then((transactionResult) => new TransactionResult(transactionResult.committed, new DataSnapshot(this.database, transactionResult.snapshot)));
	...
	*/
	var Database = class {
		...
		*/
		refFromURL(url) {
			require$$2$3.validateArgCount("database.refFromURL", 1, 1, arguments.length);
	...
	*/
	function initStandalone$1({ app, url, version, customAuthImpl, customAppCheckImpl, namespace, nodeAdmin = false }) {
		...
		*/
		...
		authProvider.setComponent(new require$$0$2.Component("auth-internal", () => customAuthImpl, "PRIVATE"));
		let appCheckProvider = void 0;
		if (customAppCheckImpl) {
			appCheckProvider = new require$$0$2.Provider("app-check-internal", container);
			appCheckProvider.setComponent(new require$$0$2.Component("app-check-internal", () => customAppCheckImpl, "PRIVATE"));
		}
		return {
...
//#endregion
export { require_index_standalone as t };
