...
var require_db_connections = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var maximumDuration = 900 * 1e3 - 1e3;
	...
	var experimental_attachDatabasePool = attachDatabasePool;
}));
//#endregion
