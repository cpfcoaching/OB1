...
import { n as require_dist } from "../vercel__oidc.mjs";
import * as fs from "fs";
import * as path from "path";
import * as net from "net";
//#region node_modules/@workflow/world-vercel/node_modules/mixpart/dist/index.mjs
	...
	*/
	write(chunk) {
		...
		if (this.buffer !== null) {
			...
			if (newSize > maxAllowedSize) throw new MultipartParseError(`Buffer size limit exceeded: ${newSize} bytes > ${maxAllowedSize} bytes. This may indicate malformed multipart data with ${this.state === 2 ? "oversized headers" : "invalid boundaries"}.`);
...
//#endregion
//#region node_modules/@workflow/world-vercel/node_modules/balanced-match/dist/esm/index.js
...
//#endregion
//#region node_modules/@workflow/world-vercel/node_modules/brace-expansion/dist/esm/index.js
...
//#endregion
//#region node_modules/@workflow/world-vercel/node_modules/minimatch/dist/esm/assert-valid-pattern.js
...
//#endregion
//#region node_modules/@workflow/world-vercel/node_modules/minimatch/dist/esm/brace-expressions.js
var posixClasses = {
...
//#endregion
//#region node_modules/@workflow/world-vercel/node_modules/minimatch/dist/esm/unescape.js
/**
...
//#endregion
//#region node_modules/@workflow/world-vercel/node_modules/minimatch/dist/esm/ast.js
var _a;
var types = new Set([
	"!",
	"?",
...
_a = AST;
//#endregion
//#region node_modules/@workflow/world-vercel/node_modules/minimatch/dist/esm/escape.js
/**
...
//#endregion
//#region node_modules/@workflow/world-vercel/node_modules/minimatch/dist/esm/index.js
...
//#endregion
//#region node_modules/@workflow/world-vercel/node_modules/@vercel/queue/dist/index.mjs
...
function parseV1StructuredBody(body, contentType) {
	...
	if (body.type !== "com.vercel.queue.v1beta") throw new Error(`Invalid CloudEvent type: expected '${CLOUD_EVENT_TYPE_V1BETA}', got '${String(body.type)}'`);
	const { data } = body;
	const missingFields = [];
...
function parseBinaryHeaders(headers) {
	...
	if (ceType !== "com.vercel.queue.v2beta") throw new Error(`Invalid CloudEvent type: expected '${CLOUD_EVENT_TYPE_V2BETA}', got '${ceType}'`);
	...
	const base = {
		...
		consumerGroup,
		messageId,
		region: getHeader(headers, "ce-vqsregion") ?? void 0
	};
...
Cause: ${cause}`);
	...
	async sendMessage(options) {
		...
		if (response.status === 202) return { messageId: null };
	...
	async acknowledgeMessage(options) {
		...
		if (!response.ok) {
			...
			throwCommonHttpError(response.status, response.statusText, errorText, "acknowledge message", "Missing or invalid receipt handle");
		}
	...
	async changeVisibility(options) {
		...
		if (!response.ok) {
			...
			if (response.status === 404) throw new MessageNotFoundError(receiptHandle);
			if (response.status === 409) throw new MessageNotAvailableError(receiptHandle, errorText || "Invalid receipt handle, message not in correct state, or already processed");
			throwCommonHttpError(response.status, response.statusText, errorText, "change visibility", "Missing receipt handle or invalid visibility timeout");
		}
		return { success: true };
	}
};
